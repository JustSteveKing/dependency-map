<section class="lg:pr-96">
    <header class="flex items-center justify-between border-b border-black/5 dark:border-white/5 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
        <h1 class="text-base font-semibold leading-7">Projects</h1>
    </header>
    ...
    <ul role="list" class="divide-y divide-black/5 dark:divide-white/5">
        ...
        @empty
            <x-empty
                title="No projects"
                message="Get started by registering your project"
            >
                <a wire:navigate href="{{ route('pages:projects:create') }}" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    <x-icon name="project" class="-ml-0.5 mr-1.5 h-5 w-5" />
                    New Project
                </a>
            </x-empty>
        @endforelse
